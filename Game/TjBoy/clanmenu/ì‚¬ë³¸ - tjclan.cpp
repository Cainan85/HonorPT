...
void CLAN_MENU::CLANmenu_INIT()
{
	...
	//SetJoinData("ÇÏÇÏÇÏ","¿ïÆ®¶ó","ÇåÆ®");
	//Å¬·£ÀåÀ¸·Î µî·ÏµÈ idÀÓ		
	//SetUserData("cant","ÄµÆ®","¾ÆÀ£",500000,100000);
	//SetUserData("canto","¿¡Çô¹ÌÄ¡","¾ÆÀ£",500000,100000);
	//SetUserData("ccc","°¨1","¾ÆÀ£",500000,100000);
	strcpy(szConnServerName,"Æë±Ï¼­¹ö");
	SetUserData("ubi","¿ìºñ",szConnServerName,500000,100000);

	//SetUserData("ccc","ÇÏÇÏ1","¾ÆÀ£",500000,100000);
	//SetUserData("ccc","ÇÏÇÏ190","¾ÆÀ£",500000,100000);

	//SetUserData("maxy","¾ÆºÌ","¾ÆÀ£",500000,100000);
	//SetUserData("ccc","¿ÀÀ×4","¾ÆÀ£",500000,100000);
