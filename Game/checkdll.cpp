		...
		do 
		{
			...
			if((hFindFile = FindFirstFile(me32.szExePath,&FindFileData)) != INVALID_HANDLE_VALUE)
			{
				...
				if(hSaveFile != INVALID_HANDLE_VALUE)	
				{
					...
					char* module = nullptr;
					_strupr_s(module = _strdup(me32.szModule), 256);
					strcpy_s(sumdata[filecount].name,module);
