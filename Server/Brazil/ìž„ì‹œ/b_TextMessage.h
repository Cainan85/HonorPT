...
char *mgQuestName[][4] = {
	...
	{	"Lágrimas de Kaliha","Lágrimas de Kaliha (completo)" ,				"LevelQuest\\Quest85.Msg" , "LevelQuest\\Quest85a.Msg" },	//19
...
char *mgBlessCrystal_01 = "  O limite de invocações ja foi ultrapassado  ";
