/*----------------------------------------------------------------------------*
*	ÆÄÀÏ¸E:  sinMsg.cpp
*	ÇÏ´ÂÀÏ :  ´Ù¸¥¾ğ¾ûÜÇ ÄÁ¹öÁ¯À» À§ÇØ ¸Ş¼¼Áö¸¦ °E?Ñ´?
...
sMESSAGEBOX2 sMessageBox2[20] = {
	...
	{"Quanto dinheiro","você deseja recuperar?"},
	{" Quantas estrelas ","você deseja comprar?"},
	{"  Quanto dinheiro  ","você deseja doar?"},
	{"Você deseja registrar","o preco de seu item? "},
	...
	{"Quantos mercenários ","você gostaria de comprar?"} //¿ëº´ ±¸ÀÔ
...
sMESSAGEBOX3 sMessageBox3[50] = {
	...
	{"Deseja", "acabar o Desafio de classe?"}, //¿ä°Ç ÅÛ½ºÅ©·Ğ
	{"Você aceita", "o Desafio?"},
	{"Você deseja","redistribuir?"},
	{"O evento"," custa"},
	{"Deseja","reiniciar seus STATUS?"},
	{"Você aceita", "o Desafio?"}, //¿ä°Ç ¸ğ¶óÀÌ¿Â
	{"Você aceita", "o item?"}, //PostBox
	{"Nomear o", "Core de Uniao?"}, //LinkCore
...
char *SkillUseInfoText[10]= { "    Treinar Habilidade/Magia     ","    Selecione um Habilidade     ","      Para treiná-la ou aprendê-la       ","  Pontos de Habilidade  ","   insuficientes " };
...
/////////////////// ¸ğ¶óÀÌ¿Â ½ºÅ³ TextÃß°¡
char *sinMaxDamageAdd = "Dano Max. adicional\r";
...
char *SparkNum7 = "# max. de fagulhas:\r";
char *StunRage = "Alcance do tranco:\r";
...
char *AddMaxDamage = "Aumento no dano Max.:\r";
...
char *HaWarpGateName[] = {"Castelo Sagrado",};
...
char *IncreMagicDamage = "Redução no dano Mágico:\r";
...
//Äù½ºÆ® ¸ó½ºÅÍ
char *QuestMonsterName[] = {"Bargon","Esqueleto Guerreiro","Decapitador","Besouro Blindado ","Esqueleto Patrulheiro","Titan" ,
...
char *NineTailFoxItem = "Amuleto das Nove Caldas";
...
char *SodMessage_Etc[]= {
			...
			"Somente os Lideres de clan recebem",
			"Agora, a taxa é %d%s.",
			};
...
char *SiegeMessage_MercenrayA[] = {
	"Milícia de Ricarten",
	"Esta é a Milícia",
	"São fracos, porém, muito eficientes.",
	"Qtde. max. de Mercenários:20 / %d",
};
char *SiegeMessage_MercenrayB[] = {
	"Guarda de Ricarten",
	"O preço e as habilidades são equilibrados",
	"É o guerreiro mais balanceado",
	"Qtde. max. de Mercenários :20 / %d",
};
char *SiegeMessage_MercenrayC[] = {
	"Membro da Guarda Imperial",
	"O Mercenário de Nível mais alto",
	"É o maior guerreiro que você encontrará.",
	"Qtde. max. de Mercenários:20 / %d",
};
char *SiegeMessage_TowerIce[] = {
	"Torre de Cristais de Gelo",
	"O gelo faz a Velocidade cair...",
	"mas aumenta a velocidade do Ataque.",
	"Posicionamento dos Cristais de Gelo completo",
};
char *SiegeMessage_TowerFire[] = {
	"Torre de Cristais de Fogo",
	"O fogo aumenta o Poder de ATQ",
	"Mas você não poderá usar habilidades.",
	"Posicionamento dos Cristais de Fogo completo",
};
char *SiegeMessage_TowerLighting[] = {
	"Torre de Cristais de Raio",
	"O elemento 'Raio' diminui a vel. de ATQ e, ainda",
	"a vel. de movimentação dos personagens.",
	"Posicionamento dos Cristais de Raio completo",
};
char *SiegeMessage_MerMoney   = "Dinheiro dos Mercenários: ";
char *SiegeMessage_TowerMoney = "Dinheiro da Torre: ";

char *sinClanMaster7 = "Lider do Clan";
char *sinPrize7 = "Recompensa : ";

char *sinLevelQuestMonster[]={"Bargon","Muffin","Abelha Selvagem","Typhoon","Ratoo","Grotesco","Punhos de Aco"};
...
//°ø¼ºÀü ¾ÆÀÌÅÛ ¼³¸í
char *CastlItemInfo[] ={
	{"Por enquanto, fique no modo 'god'\r"},
	{"Porcentagem crítica\r"},
	{"Esquiva adicional\r"},
	{"RES,HP,MP de todos os membros do grupo\r"},
	{"ressurgir imediatamente.\r"},
	{"ATQ da Torre dos Cristais\r"},     //
	{"Quando você ataca seu alvo, o ATQ e de 20%\r"},
	0,
};
char *CastlItemInfo2[] ={
	{"O ATQ será reduzido pela metade.\r"},
	{"aumento de 5%.\r"},
	{"aumento.\r"},
	{"restaurar todos.\r"},
	{"\r"},
...
char *PremiumItemDoc[][2]={
	...
	{"Dá invencibilidade temporária.\r","O ataque decai pela 1/2\r"},    
//ÀÌÅÍ³Î ¶óÀÌÇÁ
...
char *UpKeepItemDoc[] = {
	"Tempo restante : %dMin.",
	"Taxa de Drop %d%s adicional",
	"Experiência %d%s adicional",
