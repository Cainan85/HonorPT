...
INT WINAPI WinMain(HINSTANCE hInst, HINSTANCE hPreInst, LPSTR lpCmdLine, INT nCmdShow)
{
...

	{
		...
		if (LoadCurses("Image\\brazil_curse.cht") != -2194)
		{
			Log::Error("Curse inválido. Esperado: " + std::to_string(CurseID));
		}
	}

	{
		...
		if (CurseID != -2194)
		{
			Log::Error("CurseID inválido. Esperado: " + std::to_string(CurseID));
		}
	}
